...
task1p1 = ProjectTask.create(name: 'Create Login', importance: 'low', deadline: '11/20/2020', description: 'Have Brendan call Jeff and discuss project layout. Mention project timeline and determine they are in agreement. Do not forget to ask about his wife, Julie - she recently had knee surgery. Adding more to this to make sure I get to the second line. Maybe even three lines, we will see.', status: 'incomplete', project_id: proj1.id)
...
task6p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: '11/21/2020', description: 'Meet with team and collaborate on MVP.', status: 'incomplete', project_id: proj1.id)
task7p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: '10/20/2020', description: 'Project ideation and timeline plans.', status: 'incomplete', project_id: proj1.id)
