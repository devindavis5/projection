...
dt7 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), status: 'incomplete', user_id: dev.id)
...
dt11 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("20/12/2020"), status: 'incomplete', user_id: dev.id)
