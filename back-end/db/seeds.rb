...
# proj2 = Project.create(name: 'Haley Project', deadline: 12/02/2020, notes: 'Some note', user_id: haley.id)
# proj3 = Project.create(name: 'The Domain', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj4 = Project.create(name: 'Animals Anonymous', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj5 = Project.create(name: 'Highlands', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj6 = Project.create(name: 'San Francisco Brewery', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj7 = Project.create(name: 'NY First Bank', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj8 = Project.create(name: 'In House Security', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj9 = Project.create(name: 'Onboarding System', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj10 = Project.create(name: 'Company Website', deadline: 12/02/2020, notes: 'Some note', user_id: dev.id)
# proj11 = Project.create(name: 'Absolute Agenda', deadline: 12/02/2020, notes: 'Some note. lsjf;alkdjsflksjdfklsjdf;kjsd;flkjdklfjsdl;kfjsdlkfjsd;lkfjs;dlkfjsdlkfjsd;lkfsjd;lfkjsd;lfkjsd;lfkjdflsdkf;fskdlfjsdlkfjdslkfjsdlkfjsdlk.fdslkfjdlksjflkdjflksd.', user_id: dev.id)
...
# task2p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: 12/02/2020, description: 'Review login and discuss security with Karley.', status: 'incomplete', project_id: proj1.id)
# task3p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: 01/08/2021, description: 'Review stretch goals and determine what can be implemented.', status: 'incomplete', project_id: proj1.id)
# task4p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: 02/23/2021, description: 'Walk-through project with client. Ask if the process has been up to his standards.', status: 'incomplete', project_id: proj1.id)
# task5p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: 02/24/2021, description: 'Deliver project.', status: 'incomplete', project_id: proj1.id)
task6p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("21/11/2020"), description: 'Meet with team and collaborate on MVP.', status: 'incomplete', project_id: proj1.id)
task7p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("20/10/2020"), description: 'Project ideation and timeline plans.', status: 'incomplete', project_id: proj1.id)
...
# dt4 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt5 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt6 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt7 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt8 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt9 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt10 = DailyTask.create(description: 'Assign New to 3 Team Membersfd faldkf jasdl fsld', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt11 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt12 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt13 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt14 = DailyTask.create(description: 'Assign New to 3 Team Membldaf dslkfajd ers', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt15 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt16 = DailyTask.create(description: 'Assign New to 3 Team Mefdlkas fdlk fklasdjf lfdkjaflkdmbers', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
# dt17 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: 12/02/2020, status: 'incomplete', user_id: dev.id)
