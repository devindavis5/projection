...
proj6 = Project.create(name: 'San Francisco Brewery', deadline: Date.parse("02/12/2020"), archived: false, notes: 'Some note', user_id: dev.id)
proj7 = Project.create(name: 'NY First Bank', deadline: Date.parse("20/11/2020"), archived: false, notes: 'Some note', user_id: dev.id)
proj8 = Project.create(name: 'In House Security', deadline: Date.parse("10/12/2020"), archived: true, notes: 'Some note', user_id: dev.id)
proj9 = Project.create(name: 'Onboarding System', deadline: Date.parse("10/2/2021"), archived: true, notes: 'Some note', user_id: dev.id)
proj10 = Project.create(name: 'Company Website', deadline: Date.parse("02/12/2020"), archived: false, notes: 'Some note', user_id: dev.id)
proj11 = Project.create(name: 'Absolute Agenda', deadline: Date.parse("02/12/2020"), archived: false, notes: 'Some note. lsjf;alkdjsflksjdfklsjdf;kjsd;flkjdklfjsdl;kfjsdlkfjsd;lkfjs;dlkfjsdlkfjsd;lkfsjd;lfkjsd;lfkjsd;lfkjdflsdkf;fskdlfjsdlkfjdslkfjsdlkfjsdlk.fdslkfjdlksjflkdjflksd.', user_id: dev.id)

task1p1 = ProjectTask.create(name: 'Create Login', importance: 'low', deadline: Date.parse("20/11/2020"), description: 'Have Brendan call Jeff and discuss project layout. Mention project timeline and determine they are in agreement. Do not forget to ask about his wife, Julie - she recently had knee surgery. Adding more to this to make sure I get to the second line. Maybe even three lines, we will see.', archived: false, project_id: proj1.id)
task2p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("21/11/2020"), description: 'Review login and discuss security with Karley.', archived: true, project_id: proj1.id)
task3p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("20/1/2021"), description: 'Review stretch goals and determine what can be implemented.', archived: false, project_id: proj1.id)
task4p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("01/1/2021"), description: 'Walk-through project with client. Ask if the process has been up to his standards.', archived: false, project_id: proj1.id)
task5p1 = ProjectTask.create(name: 'Create Signup', importance: 'medium', deadline: Date.parse("20/2/2021"), description: 'Deliver project.', archived: false, project_id: proj1.id)
...
dt1 = DailyTask.create(description: 'Assign New Project Ideation to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt2 = DailyTask.create(description: 'Assign New Project Structure to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt4 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt5 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("03/12/2021"), archived: false, user_id: dev.id)
dt6 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt7 = DailyTask.create(description: 'COMPLETE COMPLETE COMPLETE', deadline: Date.parse("02/12/2020"), archived: true, user_id: dev.id)
dt8 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("013/2/2021"), archived: false, user_id: dev.id)
dt9 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt10 = DailyTask.create(description: 'Assign New to 3 Team Membersfd faldkf jasdl fsld', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt11 = DailyTask.create(description: 'COMPLETE COMPLETE COMPLETE', deadline: Date.parse("20/12/2020"), archived: true, user_id: dev.id)
dt12 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt13 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("10/12/2020"), archived: false, user_id: dev.id)
dt14 = DailyTask.create(description: 'Assign New to 3 Team Membldaf dslkfajd ers', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt15 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt16 = DailyTask.create(description: 'Assign New to 3 Team Mefdlkas fdlk fklasdjf lfdkjaflkdmbers', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
dt17 = DailyTask.create(description: 'Assign New to 3 Team Members', deadline: Date.parse("02/12/2020"), archived: false, user_id: dev.id)
