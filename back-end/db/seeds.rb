...
proj4 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj5 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj6 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj7 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj8 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj9 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj10 = Project.create(name: 'Devin Second Project', deadline: 'Dec 2, 2020', notes: 'Some note', user_id: dev.id)
proj11 = Project.create(name: 'Devin Second Project', deadline: 'December 2, 2020', notes: 'Some note. lsjf;alkdjsflksjdfklsjdf;kjsd;flkjdklfjsdl;kfjsdlkfjsd;lkfjs;dlkfjsdlkfjsd;lkfsjd;lfkjsd;lfkjsd;lfkjdflsdkf;fskdlfjsdlkfjdslkfjsdlkfjsdlk.fdslkfjdlksjflkdjflksd.', user_id: dev.id)
...
tm3 = TeamMember.create(name: 'Devin', image: 'https://scontent-dfw5-2.xx.fbcdn.net/v/t1.0-9/124116460_784088595769085_5257786213152791880_n.jpg?_nc_cat=102&ccb=2&_nc_sid=09cbfe&_nc_ohc=h4Qmo4tlUnoAX_AMOd4&_nc_ht=scontent-dfw5-2.xx&oh=548248441c8d3a723d016d352746ad98&oe=5FDA9A91', user_id: dev.id)
