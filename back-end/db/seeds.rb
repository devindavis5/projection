...
proj2 = Project.create(name: 'Haley Project', deadline: Date.parse("02/12/2020"), notes: 'Notes:', user_id: haley.id)
proj3 = Project.create(name: 'The Domain', deadline: Date.parse("01/08/2021"), notes: 'Notes:', user_id: dev.id)
proj4 = Project.create(name: 'Animals Anonymous', deadline: Date.parse("02/12/2020"), notes: 'Notes:', user_id: dev.id)
proj5 = Project.create(name: 'Highlands', deadline: Date.parse("26/11/2020"), notes: 'Notes:', user_id: dev.id)
