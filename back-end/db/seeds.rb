...
task7p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("20/10/2020"), description: 'Project ideation and timeline plans.', archived: true, project_id: proj1.id)
...
task6p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("05/3/2021"), description: 'Deliver project.', archived: false, project_id: proj1.id)

task7p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("27/10/2020"), description: 'Project ideation and timeline plans.', archived: true, project_id: proj3.id)
task1p2 = ProjectTask.create(name: proj3.name, importance: 'low', deadline: Date.parse("28/11/2020"), description: 'Call Jeff and discuss project layout. Mention project timeline and determine they are in agreement. Do not forget to ask about his wife, Julie - she recently had knee surgery.', archived: false, project_id: proj3.id)
task2p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("30/11/2020"), description: 'Review login and confirm authentication is fully functional.', archived: true, project_id: proj3.id)
task3p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("26/1/2021"), description: 'Collaborate on MVP. Have questions prepared for our meeting if you have any questions about extended deliverables.', archived: false, project_id: proj3.id)
task4p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("06/1/2021"), description: 'Walk-through project with client. Ask if the process has been up to his standards.', archived: false, project_id: proj3.id)
task5p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("27/2/2021"), description: 'Review stretch goals prior to our meeting. Come with ideas on what you think can be implemented.', archived: false, project_id: proj3.id)
task6p2 = ProjectTask.create(name: proj3.name, importance: 'medium', deadline: Date.parse("15/3/2021"), description: 'Deliver project.', archived: false, project_id: proj3.id)
...
dt1 = DailyTask.create(description: 'Performance review with Brendan', deadline: Date.parse("07/12/2020"), archived: false, user_id: dev.id)
dt2 = DailyTask.create(description: 'Meet with team on NY First Bank ideation', deadline: Date.parse("04/12/2020"), archived: false, user_id: dev.id)
dt4 = DailyTask.create(description: 'Performance review with Karley', deadline: Date.parse("07/12/2020"), archived: false, user_id: dev.id)
dt5 = DailyTask.create(description: 'Meet with team on Arcane Central progress 3pm', deadline: Date.parse("07/12/2020"), archived: false, user_id: dev.id)
dt6 = DailyTask.create(description: 'Lunch with Joe 12pm', deadline: Date.parse("04/12/2020"), archived: false, user_id: dev.id)
dt7 = DailyTask.create(description: 'Call Emma, confirm she is feeling alright with the Arcane Central timeframe', deadline: Date.parse("08/12/2020"), archived: true, user_id: dev.id)
...
dt9 = DailyTask.create(description: 'Review upcoming deadlines, team meeting is scheduled tentatively for 2pm.', deadline: Date.parse("14/12/2020"), archived: true, user_id: dev.id)
...
dt12 = DailyTask.create(description: 'Send progress report to Phil', deadline: Date.parse("04/12/2020"), archived: false, user_id: dev.id)
dt13 = DailyTask.create(description: 'Performance review with Jake', deadline: Date.parse("08/12/2020"), archived: true, user_id: dev.id)
dt14 = DailyTask.create(description: 'Ask Jake to elaborate on idea he had for Arcane Central stretch goal', deadline: Date.parse("04/12/2020"), archived: false, user_id: dev.id)
dt15 = DailyTask.create(description: 'Meet with team and assign tasks for San Francisco Brewery 11am', deadline: Date.parse("09/12/2020"), archived: false, user_id: dev.id)
dt16 = DailyTask.create(description: 'Performance review with Ana', deadline: Date.parse("08/12/2020"), archived: false, user_id: dev.id)
dt17 = DailyTask.create(description: 'Pick up dinner on way home', deadline: Date.parse("04/12/2020"), archived: true, user_id: dev.id)
