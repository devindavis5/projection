...
task2p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("21/11/2020"), description: 'Review login and discuss security with Karley.', archived: true, project_id: proj1.id)
task3p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("20/1/2021"), description: 'Review stretch goals and determine what can be implemented.', archived: false, project_id: proj1.id)
...
task5p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("20/2/2021"), description: 'Deliver project.', archived: false, project_id: proj1.id)
task6p1 = ProjectTask.create(name: proj1.name, importance: 'medium', deadline: Date.parse("21/11/2020"), description: 'Meet with team and collaborate on MVP.', archived: true, project_id: proj1.id)
